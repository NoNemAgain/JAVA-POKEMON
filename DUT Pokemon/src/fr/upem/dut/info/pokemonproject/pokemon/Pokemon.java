...
public class Pokemon implements Serializable {
	...
	public boolean equals(Object o) {
		...
		Pokemon p = (Pokemon) o;
		return number == p.number && name.equals(p.name) && path.equals(p.path) && height == p.height
				&& weight == p.weight && type.equals(p.type) && type2.equals(p.type2);
	}
	...
	public PokemonFight createPokemon() {
		...
		return new PokemonFight(number, name, path, height, weight, type, type2, Pokemon.random(1, 100),
				Pokemon.random(100, 300), Pokemon.random(30, 180), Pokemon.random(30, 180), Pokemon.random(10, 200),
				Pokemon.random(10, 200), Pokemon.random(0, 180));
	}
